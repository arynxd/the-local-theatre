...
export default function Contact() {
	return (
		<div className="md:flex md:justify-center md:w-auto">
			<div className="flex flex-col w-auto items-center md:w-1/3 h-44 m-2 rounded-2xl shadow-xl bg-gray-200 dark:bg-gray-500">
				...
				<div className="flex flex-row items-center">
					...
					<a href="mailto:admin@test.com">
						<p className="text-xl m-2 text-gray-800 dark:text-gray-300">
				...
				<div className="flex flex-row items-center mb-4">
					...
					<p className="text-xl m-3 text-gray-800 dark:text-gray-300">
