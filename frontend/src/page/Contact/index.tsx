...
export default function Contact() {
    return (
        ...
        <div className='md:flex md:justify-center md:w-auto md:h-screen'>
            <div className='flex flex-col w-auto items-center md:w-1/3 h-44 m-2 rounded-2xl shadow-xl bg-blue-100 dark:bg-gray-500'>
                ...
                <div className='flex flex-row items-center'>
                    ...
                    <a href="mailto:admin@test.com"><p className='text-xl m-2 text-gray-800 dark:text-gray-300'>admin@test.com</p></a>
                </div>
